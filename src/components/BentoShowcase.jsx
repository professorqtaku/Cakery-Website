        ...
        <section className="bg-neutral/20 py-24">
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-auto md:h-[800px]">
                    {/* Item 1 - Large (2x2) */}
                    <div className="md:col-span-2 md:row-span-2 group relative rounded-2xl overflow-hidden bg-neutral patisserie-shadow">
                        <img
                    ...
                    {/* Item 2 - Medium (2x1) */}
                    <div className="md:col-span-2 group relative rounded-2xl overflow-hidden bg-neutral patisserie-shadow">
                        <img
                    ...
                    {/* Item 3 - Small (1x1) */}
                    <div className="group relative rounded-2xl overflow-hidden bg-neutral patisserie-shadow">
                        <img
